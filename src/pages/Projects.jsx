  ...
  return (
    <div className="page-stack">
      ...
      <section className="manual-section">
        ...
        <Link to="/projects/research-stocks-pro-open-price" className="record">
          <div className="record-meta">
          ...
          <p className="record-copy">
            A dated collection of pre-market stock research reports generated by
            my stock analysis agents before the market opens.
          </p>
          <div className="tag-row mt-4">
