...
# The AI Economic Paradox: When Replacing Workers Destroys the Customers Who Buy What You Sell

The pitch is simple. Deploy AI, cut costs, boost margins, grow the business. Every CEO in every earnings call is saying some version of this right now.
...
Firm A replaces workers with AI. Saves costs. Improves margins. Looks smart on the quarterly call.

Displaced workers lose income. They spend less. Consumer spending is 70% of US GDP, and consumer spending is funded by labor income.

Other firms see lower sales. They face margin pressure. They adopt AI to cut costs too.

More workers displaced. More demand destruction. More firms adopt AI.
...
An automating firm captures 100% of the cost savings. But under competitive pricing, it bears only a fraction of the resulting demand destruction. The rest falls on rivals.

Each firm's profit-maximizing automation rate exceeds the cooperatively efficient level. Even knowing this, no firm can unilaterally stop. It would be outcompeted.

The result: collective harm that no individual firm can prevent. Over-automation that makes firms collectively worse off, even though each firm individually benefits from automating.

## Ghost GDP

There is a concept called Ghost GDP. When AI-generated output substitutes for labor-generated output, the same nominal GDP circulates through fewer wage-earning agents.

Consumer spending is 70% of US GDP. Consumer spending is funded by labor income. Labor's share of income has been falling: 64% in 1974 to 56% in 2024. If AI accelerates this decline, aggregate demand falls even as output rises.

GDP numbers look fine. But the consumption-relevant economy contracts.

A February 2026 Fortune report found 89% of managers saw no productivity change despite AI adoption rising from 61% to 71%. Workers spend 5.7% of time using AI but save only 1.6% of total work time. The San Francisco Fed called it "possibilities without realized productivity."

## The Concentration Problem

The top 20% of US income earners account for roughly 59% of aggregate consumer spending. White-collar, knowledge-economy workers are disproportionately represented in this top quintile. These are precisely the workers most exposed to AI automation.

A technology that compresses white-collar wages or employment has a consumption impact far exceeding its direct labor-share effect. If the people who spend the most are the ones losing jobs, the demand destruction is amplified.

Over 100,000 entry-level positions have been lost. The displaced roles are disproportionately middle-income positions with high marginal propensity to consume. The exact workers who drive consumer spending.

## The Resource Tax

AI does not just destroy jobs. It drives up the cost of living for everyone, further reducing consumer purchasing power.

**Power:** US data centers consumed 176 TWh in 2023. Projected to reach 6.7% to 12% of national grid by 2028. Electricity prices rose 7.1% nationally. Areas with high data center concentrations saw electricity prices jump 267% over 5 years.

**DRAM:** Memory prices rose 80% to 90% in Q1 2026 alone. Samsung, SK Hynix, and Micron are redirecting wafer production from consumer DDR5 to high-margin HBM for AI chips. Apple MacBooks and iPads are up 10% to 20%. Xbox is up 30% to 40% year-over-year. Laptops are up 15% to 30%.

Microsoft warned: "Storage and memory prices have more than doubled and we expect costs to double again by 2027."
...
Businesses see lower sales. They cut more jobs. They adopt more AI. More AI means more power demand, more DRAM demand, higher prices. The cycle repeats with compounding pressure.

The efficiency gains from AI are being partially or fully offset by the cost increases from AI's resource demands.

## What the Counterarguments Get Wrong

**Jevons Paradox** says efficiency creates more demand. But the paradox assumes price reductions reach consumers. If they are captured as profits, or if displaced workers cannot afford the cheaper products, the paradox breaks.

**New job creation** has historical precedent. But previous transitions took decades. AI displacement is happening in years. BCG estimates 50% to 55% of US jobs will be reshaped by AI in 2 to 3 years. 10% to 15% could be eliminated in 5 years.

**Productivity gains** have not materialized yet. The Stanford Digital Economy Lab found no clear evidence of aggregate labor market disruption. But early-career workers in AI-exposed occupations show displacement signals.
...
AI is supposed to drive business growth through productivity gains. But the physical infrastructure required to run AI is driving up costs for the very consumers businesses need to sell to.

The real cost is not the fines. It is the fundamental demand problem. You can optimize your way to efficiency, but you cannot optimize your way to a customer who has no money to spend.

---

## References

1. Falk, B.H. & Tsoukalas, G. -- "The AI Layoff Trap" (arXiv, Mar 2026): https://arxiv.org/html/2603.20617v1
2. Chen, X. -- "Abundant Intelligence and Deficient Demand" (arXiv, Mar 2026): https://arxiv.org/pdf/2603.09209
3. Recursive Institute -- "The Aggregate Demand Crisis" (Feb 2026): https://recursive.institute/articles/the-aggregate-demand-crisis/
4. Goldman Sachs -- "The Jobs AI Is Likely to Boost and Those It May Disrupt" (Apr 2026): https://www.goldmansachs.com/insights/articles/the-jobs-ai-is-likely-to-boost-and-those-it-may-disrupt
5. BCG -- "AI Will Reshape More Jobs Than It Replaces" (Mar 2026): https://www.bcg.com/publications/2026/ai-will-reshape-more-jobs-than-it-replaces
6. Stanford Digital Economy Lab -- "AI Economic Indicators: June 2026 Update" (Jun 2026): https://digitaleconomy.stanford.edu/app/uploads/2026/06/AIEI_RN01_Jun26.pdf
7. NBER -- "Forecasting the Economic Effects of AI" (Working Paper 35046, Apr 2026): https://www.nber.org/papers/w35046
8. Moody's Analytics -- "The Aggregate Demand Crisis" (Feb 2026): https://recursive.institute/articles/the-aggregate-demand-crisis/
9. Consumer Reports -- "AI Data Centers Impact on Electric Bills" (Mar 2026): https://www.consumerreports.org/data-centers/ai-data-centers-impact-on-electric-bills-water-and-more-a1040338678/
10. BBC -- "Apple hikes some prices by nearly 20%" (Jun 2026): https://www.bbc.com/news/articles/c3ryj81ywlro
`;export{e as default};